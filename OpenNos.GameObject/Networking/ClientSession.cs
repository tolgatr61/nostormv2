...
namespace OpenNos.GameObject
{
    public class ClientSession
    {
        ...
        public bool IsLocalhost => IpAddress.Contains("25.81.119.156");// i dont know because this is here
                        ...
                        if (HasSelectedCharacter || methodReference.ParentHandler.GetType().Name == "CharacterScreenPacketHandler" || methodReference.ParentHandler.GetType().Name == "LoginPacketHandler")
                        {
                            ...
                            if (methodReference.PacketDefinitionParameterType != null)
                            {
                                ...
                                if (!IsAuthenticated
                                    ...
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.TrialModerator)) && Account.Authority >= AuthorityType.TrialModerator && Account.Authority <= AuthorityType.BoardAdmin
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.Moderator)) && Account.Authority >= AuthorityType.Moderator && Account.Authority <= AuthorityType.BoardAdmin
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.SuperModerator)) && Account.Authority >= AuthorityType.SuperModerator && Account.Authority <= AuthorityType.BoardAdmin
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.TrialGameMaster)) && Account.Authority >= AuthorityType.TrialGameMaster
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.GameMaster)) && Account.Authority >= AuthorityType.GameMaster
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.SuperGameMaster)) && Account.Authority >= AuthorityType.SuperGameMaster
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.GameAdmin)) && Account.Authority >= AuthorityType.GameAdmin
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.TeamManager)) && Account.Authority >= AuthorityType.TeamManager
                                    || methodReference.Authorities.Any(a => a.Equals(AuthorityType.CommunityManager)) && Account.Authority >= AuthorityType.CommunityManager
