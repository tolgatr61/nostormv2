                    ...
                    case BCardType.CardType.Morale:
                        if (SubType == (byte)AdditionalTypes.Morale.MoraleIncreased / 10)
                        {
                            if (firstData == 1)
                            {
                               /* if (IsLevelScaled)
                                {
                                    session.Character.HitRate += senderLevel * firstData * 500;
                                    session.Character.DistanceDefenceRate += senderLevel * firstData * 500;
                                    session.Character.DefenceRate += senderLevel * firstData * 500;
                                }
                                else
                                {
                                    session.Character.HitRate = firstData;
                                    session.Character.DistanceDefenceRate = firstData;
                                    session.Character.DefenceRate = firstData;
                                }*/
                            }
                        }
                        break;
