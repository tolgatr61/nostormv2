...
namespace OpenNos.World
{
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.Title = $"OpenNos World Server - Act 4 - Channel : 51{(_isDebug ? " Development Environment" : "")}";
            ...
            if (!ignoreStartupMessages)
            {
                ...
                string text = $"WORLD SERVER ACT4 v{fileVersionInfo.ProductVersion}dev - PORT : {_port} by OpenNos Team ";
